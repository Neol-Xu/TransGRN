...
def extract_cell_line_data(cell_line, data_type, network, num_genes, sample, ratio=None):
    if data_type == "pre_train":
        data_path = f'demo_data/Source_data/{network}/{cell_line}_{num_genes}/{sample}/Train_set.csv'
